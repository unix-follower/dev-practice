...
describe("Calculus Chrome WebDriver Tests", () => {
  ...
  test("should render the Calculus placeholder text", async () => {
    await driver.get(`${baseUrl}/math/calculus`)

    const placeholder = "Calculus placeholder"
