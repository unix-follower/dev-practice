...
describe("Geometry Chrome WebDriver Tests", () => {
  ...
  test("should render the Geometry placeholder text", async () => {
    await driver.get(`${baseUrl}/math/geometry`)

    const placeholder = "Geometry placeholder"
