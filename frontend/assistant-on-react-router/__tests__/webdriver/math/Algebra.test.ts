...
describe("Algebra Chrome WebDriver Tests", () => {
  ...
  test("should render the Algebra placeholder text", async () => {
    await driver.get(`${baseUrl}/math/algebra`)

    const placeholder = "Algebra placeholder"
