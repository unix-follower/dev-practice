...
describe("Precalculus Chrome WebDriver Tests", () => {
  ...
  test("should render the Precalculus placeholder text", async () => {
    await driver.get(`${baseUrl}/math/precalculus`)

    const placeholder = "Precalculus placeholder"
