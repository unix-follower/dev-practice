...
describe("MultivariableCalculus Chrome WebDriver Tests", () => {
  ...
  test("should render the MultivariableCalculus placeholder text", async () => {
    await driver.get(`${baseUrl}/math/multivariable-calculus`)

    const placeholder = "MultivariableCalculus placeholder"
