...
describe("Inorganic Home Chrome WebDriver Tests", () => {
  ...
  test("should render the Inorganic Home placeholder text", async () => {
    await driver.get(`${baseUrl}/chemistry/inorganic`)
