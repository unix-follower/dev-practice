...
class AbstractObjectFactory(ABC):
    ...
    @abstractmethod
    def register_factory_method(self, name: str, scope: str, creator: Callable[[...], Any]):
        pass

    @abstractmethod
    def register_async_factory_method(self, name: str, scope: str, creator: Callable[[...], Awaitable[Any]]):
        pass
