...
from app.errors.db_exceptions import DbException
            ...
            async with self._lock:
                if self._engine is None:
                    self._engine = create_async_engine(
                        self._settings.model_extra[
                            constants.DOCUMENT_EMBEDDING_DB_URL.lower()
                        ],
                    )
...
class DocumentEmbeddingAsyncDatabaseConnection(AbstractAsyncDatabaseConnection):
    _instance = None
