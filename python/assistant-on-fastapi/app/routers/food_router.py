...
from app.config.dependency_injection import get_food_predict_api_facade
from app.internal.food_predict_api_facade import FoodPredictApiFacade
...
async def predict_food(
    ...
    food_predict_api_facade: Annotated[
        FoodPredictApiFacade, Depends(get_food_predict_api_facade)
    ],
):
